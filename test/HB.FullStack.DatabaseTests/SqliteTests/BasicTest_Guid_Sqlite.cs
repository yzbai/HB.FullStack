...
{
    [TestClass]
    public class BasicTest_Guid_Sqlite : BaseTestClass
    {
...
";
            ...
            using IDataReader reader = await engine.ExecuteCommandReaderAsync(DbConfigManager.GetRequiredConnectionString(DbSchema_Sqlite, true), new DbEngineCommand(sql));
        ...
        public async Task Test_ModelMapperPerformanceAsync()
        {
            ...
            using SqliteConnection mySqlConnection = new SqliteConnection(SqliteConnectionString);
