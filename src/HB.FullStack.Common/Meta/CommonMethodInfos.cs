...
namespace HB.FullStack.Common.Meta
{
    public static class CommonReflectionInfos
    {
        ...
        public static readonly MethodInfo ConvertToStringMethod = typeof(StringConvertCenter).GetMethod(nameof(ToString), new Type[] { typeof(object), typeof(Type), typeof(StringConvertPurpose) })!;
        ...
        public static readonly ConstructorInfo PropertyValueConstructorInfo = typeof(Meta.PropertyNameValue).GetConstructor(new Type[] { typeof(string), typeof(object) })!;
    }
}
