...
namespace HB.Infrastructure.Aliyun
{
    internal static class AliyunErrorCodes
    {
        ...
        public static ErrorCode StsError { get; set; } = new ErrorCode(6001, nameof(StsError), "");
        public static ErrorCode SmsSendError { get; set; } = new ErrorCode(6002, nameof(SmsSendError), "");
        public static ErrorCode SmsFormatError { get; set; } = new ErrorCode(6003, nameof(SmsFormatError), "");
        public static ErrorCode SmsClientError { get; set; } = new ErrorCode(6004, nameof(SmsClientError), "");
        public static ErrorCode SmsServerError { get; set; } = new ErrorCode(6005, nameof(SmsServerError), "");
        public static ErrorCode SmsCacheError { get; set; } = new ErrorCode(6006, nameof(SmsCacheError), "");
    }
