...
namespace HB.FullStack.Client.MauiLib.Components
{
    ...
    public partial class SmsVerifyViewModel : BaseViewModel
    {
        ...
        public SmsVerifyViewModel(ILogger logger, ITokenPreferences clientPreferences, IFileManager fileManager, IApiClient apiClient, ISmsService smsService) : base(logger, clientPreferences, fileManager)
        {
