...
{
	public sealed class AuthUriImageSourceHandler : IImageSourceHandler, IAnimationSourceHandler
	{
		[Foundation.Preserve(Conditional = true)]
		public AuthUriImageSourceHandler()
		{
		}
		...
		{
			FormsCAKeyFrameAnimation? animation = await ImageAnimationHelper.CreateAnimationFromUriImageSourceAsync((AuthUriImageSource)imagesource, cancelationToken).ConfigureAwait(false);
			if (animation == null)
			{
	...
	internal class ImageAnimationHelper
	{
		...
		static public async Task<FormsCAKeyFrameAnimation?> CreateAnimationFromUriImageSourceAsync(AuthUriImageSource imageSource, CancellationToken cancelationToken = default(CancellationToken))
		{
			FormsCAKeyFrameAnimation? animation = null;
