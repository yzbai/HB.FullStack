...
namespace System
{
    public static class CommonReflectionInfos
    {
        ...
        public static readonly MethodInfo ArraySetValueMethod = typeof(Array).GetMethod(nameof(Array.SetValue), [typeof(object), typeof(int)])!;
        public static readonly MethodInfo ArrayGetValueMethod = typeof(Array).GetMethod(nameof(Array.GetValue), [typeof(int)])!;
        public static readonly MethodInfo ArrayGetLengthMethod = typeof(Array).GetMethod(nameof(Array.GetLength), [typeof(int)])!;

        public static readonly MethodInfo StringConcatMethod = typeof(string).GetMethod(nameof(string.Concat), [typeof(object), typeof(object)])!;
        public static readonly MethodInfo ConvertToStringMethod = typeof(StringConvertCenter).GetMethod(nameof(StringConvertCenter.ToStringFrom), [typeof(object), typeof(Type), typeof(StringConvertPurpose)])!;
        ...
        public static readonly ConstructorInfo PropertyValueConstructorInfo = typeof(PropertyNameValue).GetConstructor(new Type[] { typeof(string), typeof(object) })!;
    }
}
