...
namespace System
{
    public static class ThrowIf
    {
        ...
        [return: NotNull]
        public static IEnumerable<T> NotValid<T>([ValidatedNotNull] IList<T> ts, string paramName) where T : IValidatableObject
        {
            if (ts.Any())
            {
                foreach (var t in ts)
        ...
        [return: NotNull]
        public static IEnumerable<T> NullOrEmpty<T>([ValidatedNotNull][NotNull] IList<T>? lst, string paramName)
        {
            if (lst == null || !lst.Any())
            {
                throw new ArgumentNullException($"Parameter:{paramName}");
        ...
        public static string? NotMobile(string? mobile, string paramName, bool canBeNull)
        {
            ...
            if (!StringValidationExtensions.IsMobilePhone(mobile))
            {
                throw new ArgumentException($"Parameter:{paramName}");
            }
        ...
        public static string? NotPassword(string? password, string paramName, bool canBeNull)
        {
            ...
            if (!StringValidationExtensions.IsPassword(password))
            {
                throw new ArgumentException($"Parameter:{paramName}");
            }
        ...
        public static string? NotLoginName(string? loginName, string paramName, bool canBeNull)
        {
            ...
            if (!StringValidationExtensions.IsLoginName(loginName))
            {
                throw new ArgumentException($"Parameter:{paramName}");
            }
        ...
        public static string? NotEmail(string? email, string paramName, bool canBeNull)
        {
            ...
            if (!StringValidationExtensions.IsEmail(email))
            {
                throw new ArgumentException($"Parameter:{paramName}");
            }
        ...
        {
            if (a == null && b != null || a != null && !a.Equals(b, StringComparison.Ordinal))
            {
                throw new ArgumentException($"Parameter:{paramName}");
            }
