...
namespace HB.FullStack.Cache
{
    ...
    {
        public static async Task<(IEnumerable<TCacheModel>?, bool)> GetModelsAsync<TCacheModel>(this ICache cache, IEnumerable<TCacheModel> models, CancellationToken token = default) where TCacheModel : IModel
        {
        ...
        public static async Task<(TCacheModel?, bool)> GetModelAsync<TCacheModel>(this ICache cache, string dimensionKeyName, object dimensionKeyValue, CancellationToken token = default) where TCacheModel : IModel
        {
        ...
        public static async Task<(TCacheModel?, bool)> GetModelAsync<TCacheModel>(this ICache cache, TCacheModel model, CancellationToken token = default) where TCacheModel : IModel
        {
            CacheModelDef? modelDef = cache.GetDef<TCacheModel>();
        ...
        public static async Task<bool> SetModelAsync<TCacheModel>(this ICache cache, TCacheModel model, CancellationToken token = default) where TCacheModel : IModel
        {
        ...
        public static Task RemoveModelAsync<T>(this ICache cache, string dimensionKeyName, object dimensionKeyValue, CancellationToken token = default) => cache.RemoveModelsAsync<T>(dimensionKeyName, new object[] { dimensionKeyValue }, token);
        ...
        public static async Task RemoveModelByIdsAsync<TCacheModel>(this ICache cache, IList<object> ids, CancellationToken token = default)
        {
            ...
            await cache.RemoveModelsAsync<TCacheModel>(dimensionKeyName, ids, token).ConfigureAwait(false);
        }
    }
}
