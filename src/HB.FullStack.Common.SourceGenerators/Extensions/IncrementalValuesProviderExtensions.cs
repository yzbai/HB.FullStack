...
internal static class IncrementalValuesProviderExtensions
{
    ...
    private sealed class Comparer<TLeft, TRight> : IEqualityComparer<(TLeft Left, TRight Right)>
    {
        ...
        /// </summary>
        private readonly IEqualityComparer<TLeft> _comparerLeft;

        /// <summary>
        /// The <typeparamref name="TRight"/> comparer.
        /// </summary>
        private readonly IEqualityComparer<TRight> _comparerRight;
        ...
        {
            _comparerLeft = comparerLeft;
            _comparerRight = comparerRight;
        }
        ...
        {
            return
                _comparerLeft.Equals(x.Left, y.Left) &&
                _comparerRight.Equals(x.Right, y.Right);
        }
        ...
        public int GetHashCode((TLeft Left, TRight Right) obj)
        {
            return HashCode.Combine(
                _comparerLeft.GetHashCode(obj.Left),
                _comparerRight.GetHashCode(obj.Right));
        }
    }
