...
namespace HB.FullStack.Database
{
    public interface IDbWriter
    {
        ...
        Task UpdatePropertiesAsync<T>(TimestampUpdatePack updatePack, string lastUser, TransactionContext? transContext) where T : IDbModel;

        Task UpdatePropertiesAsync<T>(IList<TimestampUpdatePack> updatePacks, string lastUser, TransactionContext transactionContext) where T : IDbModel;
