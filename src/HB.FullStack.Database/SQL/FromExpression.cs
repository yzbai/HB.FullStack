...
{
    public class FromExpression<T> where T : class, IDbModel
    {
        ...
        public FromExpression<T> InnerJoin<TTarget>(Expression<Func<T, TTarget, bool>> joinExpr) where TTarget : class, IDbModel
        {
        ...
        public FromExpression<T> InnerJoin<TLeft, TRight>(Expression<Func<TLeft, TRight, bool>> joinExpr)
            where TLeft : class, IDbModel
            where TRight : class, IDbModel
        {
            if (JoinType != null && JoinType != SqlJoinType.INNER)
            {
                throw DbExceptions.SqlJoinTypeMixedError();
        ...
        public FromExpression<T> LeftJoin<TTarget>(Expression<Func<T, TTarget, bool>> joinExpr) where TTarget : class, IDbModel
        {
        ...
        public FromExpression<T> RightJoin<TTarget>(Expression<Func<T, TTarget, bool>> joinExpr) where TTarget : class, IDbModel
        {
        ...
        public FromExpression<T> FullJoin<TTarget>(Expression<Func<T, TTarget, bool>> joinExpr) where TTarget : class, IDbModel
        {
        ...
        public FromExpression<T> CrossJoin<TTarget>(Expression<Func<T, TTarget, bool>> joinExpr) where TTarget : class, IDbModel
        {
        ...
        private FromExpression<T> InternalJoin<Target>(string joinType, Expression joinExpr) where Target : class, IDbModel
        {
