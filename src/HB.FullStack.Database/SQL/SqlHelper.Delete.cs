...
namespace HB.FullStack.Database.SQL
{
    internal static partial class SqlHelper
    {
        ...
        public static string CreateDeleteUsingConditionSql<T>(DbModelDef modelDef, WhereExpression<T> whereExpression, bool trulyDeleted, string placeHolder = "0") where T : class, IDbModel
        {
            string cacheKey = GetCachedSqlKey(new DbModelDef[] { modelDef }, null, new List<object?> { trulyDeleted, placeHolder });
