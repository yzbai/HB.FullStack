...
namespace HB.FullStack.Database
{
    ...
    {
        public async Task UpdateAsync<T>(T item, string lastUser, TransactionContext? transContext) where T : class, IDbModel
        {
        ...
        public async Task UpdateAsync<T>(IList<T> items, string lastUser, TransactionContext transContext) where T : class, IDbModel
        {
