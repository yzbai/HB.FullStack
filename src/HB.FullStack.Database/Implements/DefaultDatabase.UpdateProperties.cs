...
namespace HB.FullStack.Database
{
    internal partial class DefaultDatabase
    {
        ...
        public Task UpdatePropertiesAsync<T>(TimestampUpdatePack updatePack, string lastUser, TransactionContext? transContext) where T : IDbModel, ITimestamp
        {
        ...
        public Task UpdatePropertiesAsync<T>(IList<TimestampUpdatePack> updatePacks, string lastUser, TransactionContext transactionContext) where T : IDbModel, ITimestamp
        {
            DbModelDef modelDef = ModelDefFactory.GetDef<T>().ThrowIfNull(typeof(T).FullName);
