...
namespace HB.FullStack.Database
{
    ...
    {
        public async Task AddAsync<T>(T item, string lastUser, TransactionContext? transContext) where T : class, IDbModel
        {
        ...
        public async Task AddAsync<T>(IList<T> items, string lastUser, TransactionContext transContext) where T : class, IDbModel
        {
