...
namespace HB.Component.Authorization
{
    internal class AuthorizationService : IAuthorizationService
    {
        ...
        private Task PreSignInCheckAsync<TUser>(TUser user, string lastUser) where TUser : User, new()
        {
        ...
        private Task OnPasswordCheckFailedAsync<TUser>(TUser user, string lastUser) where TUser : User, new()
        {
